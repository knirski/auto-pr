#!/usr/bin/env node
import{K,Q as q,S as x,T as D,Z as M,pa as N,qa as W}from"../auto-pr-generate-content-cli-md7hh08b.js";import{ge as z,kg as $,ng as j,wa as Z}from"../auto-pr-generate-content-cli-yhw399zq.js";function F(G,H,J,V,O){return z.gen(function*(){let Y=H.join(J,V),Q=yield*G.readFileString(Y),B=H.dirname(O);yield*G.makeDirectory(B,{recursive:!0}),yield*G.writeFileString(O,Q)})}var T=`Next steps (required for the workflow to create PRs):
...
//# debugId=8245C72CACA1B48D64756E2164756E21
