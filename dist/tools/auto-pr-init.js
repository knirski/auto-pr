#!/usr/bin/env node
import{L as N,M as W,t as M}from"../auto-pr-generate-content-cli-fm641hxr.js";import{Ee as K,Le as q,Pe as x,Qe as D,S as Z,Wc as $,Xb as z,Xc as j}from"../auto-pr-generate-content-cli-sd6d0vrp.js";function F(G,H,J,V,O){return z.gen(function*(){let Y=H.join(J,V),Q=yield*G.readFileString(Y),B=H.dirname(O);yield*G.makeDirectory(B,{recursive:!0}),yield*G.writeFileString(O,Q)})}var T=`Next steps (required for the workflow to create PRs):
...
//# debugId=DA135FDEB62BD18B64756E2164756E21
