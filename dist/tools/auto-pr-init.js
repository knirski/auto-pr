#!/usr/bin/env node
import{L as N,M as W,t as M}from"../auto-pr-generate-content-cli-kch7vrek.js";import{$b as z,Bc as $,Cc as j,Ne as K,S as Z,Ue as q,Ye as x,Ze as D}from"../auto-pr-generate-content-cli-kwdq98cn.js";function F(G,H,J,V,O){return z.gen(function*(){let Y=H.join(J,V),Q=yield*G.readFileString(Y),B=H.dirname(O);yield*G.makeDirectory(B,{recursive:!0}),yield*G.writeFileString(O,Q)})}var T=`Next steps (required for the workflow to create PRs):
...
//# debugId=B16F48E464E152CB64756E2164756E21
