...
1. Check existing [issues](https://github.com/knirski/auto-pr/issues) for similar reports
...
For security vulnerabilities, see [SECURITY.md](SECURITY.md). Do not report security issues in public issues.
